    ...
    <div class="container">
      <div class="row">
        <div class="col-8 mx-auto d-flex flex-column align-items-center">
          <h2 class="header-title-container mb-6 fs-2 text-accent">
            <div class="header-title-upper">
              <span class="header-title">今</span>
              <span class="header-title">天</span>
              <span class="header-title">你</span>
              <span class="header-title">要</span>
              <span class="header-title">喝</span>
              <span class="header-title">什</span>
              <span class="header-title">麼</span>
              <span class="header-title">？</span>
            </div>
            <div class="header-title-lower">
              <span class="header-title">今</span>
              <span class="header-title">天</span>
              <span class="header-title">你</span>
              <span class="header-title">要</span>
          ...
          <h3 class="d-flex fs-4 fw-bold mb-12">
            <p class="py-2 px-6 me-minus4 bg-primary rounded-pill border border-3 border-gray-900">
              給我一個支點
            </p>
      ...
      <div class="row">
        <div class="col-10 col-3xl-12 mx-auto">
          <div class="d-flex align-items-center mb-10">
            ...
            <p class="font-handwriting fs-4 fw-bold me-5">03｜05</p>
            <ul class="list-unstyled mb-0 d-flex align-items-center">
              <li><a class="btn-carouselDot me-2" href="#"></a></li>
              <li><a class="btn-carouselDot me-2" href="#"></a></li>
              <li><a class="btn-carouselDot active me-2" href="#"></a></li>
              <li><a class="btn-carouselDot me-2" href="#"></a></li>
              <li><a class="btn-carouselDot" href="#"></a></li>
            </ul>
          ...
          <div class="row index-comment">
            <div class="col-6 index-comment-start">
              ...
              <div>
                <h5 class="index-comment-start-title fs-3">
                  鮮柚葡萄綠
              ...
              <p class="index-comment-start-info fs-4 font-handwriting fw-bold">M $ 50 ｜ L $ 60</p>
